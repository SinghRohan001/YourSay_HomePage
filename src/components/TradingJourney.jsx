...
const TradingJourney = () => {
  ...
  const cards = [
    {
      ...
      content: "Stay ahead with real-time trends, expert-backed data, and in-depth insights. Enhance your awareness to make precise predictions."
    },
    {
      title: "BOOJH",
      titleHindi: "(बूझ)",
      subtitle: "ANALYSIS & STRATEGY",
      content: "Sharpen your judgment with smart analytics, historical trends, and pattern recognition. Use strategic thinking to stay competitive."
    },
    {
      title: "SAMAJH",
      titleHindi: "(समझ)",
      subtitle: "CLARITY & DECISION-MAKING",
      content: "Simplify complexity with well-structured information. Gain a deeper understanding of outcomes and make confident choices."
    }
  ];
  ...
  return (
    <div className="w-full mx-auto px-4 py-8 overflow-hidden">
      ...
      >
        " YourSay: Empowering Your Trading Journey<br />
        with Insight, Flexibility, and Success "
      </h1>
        ...
        {cards.map((card, index) => (
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="translate-y-full transition-transform duration-1000" style={{ transitionDelay: `${index * 200 + 300}ms` }}>
                <img 
                  src={Scroll}
              ...
              <div className="absolute inset-0 flex flex-col -translate-y-full transition-transform duration-1000" style={{ transitionDelay: `${index * 200 + 500}ms` }}>
                ...
                <div className="flex-none h-1/5 flex items-center justify-center">
                  <h3 className="text-white lg:text-xl font-bold">
                    {card.title} <span className="lg:text-sm">{card.titleHindi}</span>
                  </h3>
                </div>
