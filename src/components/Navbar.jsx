  ...
  return (
    <div className='fixed top-0 left-0 flex justify-between px-6 p-3 shadow-md w-full z-20 bg-white'>
      ...
      <div className='hidden lg:flex items-center space-x-2'>
        <div>
          <button type="button" className="text-white font-bold bg-blue-700 border-blue-700 border-[1px] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-3 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Download Now
          </button>
        </div>
        <div>
          <button type="button" className="text-blue-500 border-blue-500 border-[1px] font-bold rounded-lg text-sm px-5 py-2 me-2 mb-2">
            Trade Online
          </button>
        </div>
      </div>
