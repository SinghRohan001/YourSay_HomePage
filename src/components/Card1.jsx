...
const Card1 = () => {
  return (
    <div className='w-full flex justify-center lg:mt-0'>
      ...
      <div className='w-full flex justify-center mt-5 bg-no-repeat bg-fit h-[100%]' style={{
  ...
  backgroundSize: "cover",
        ...
        <div className='flex flex-col justify-center'>
          ...
          <div className='w-full flex justify-center'>
            <div className='lg:w-[70%] md:w-[70%] w-full p-4'>
              <p className='text-center text-white font-[200] text-sm lg:text-md md:text-sm'>Enter the world of Opinion Trading, where you predict real-world events with a simple "yes" or "no." Just like fantasy sports, your choices are based on live outcomes, and your accuracy can earn you real rewards. Test your instincts and win by trading on your opinions!</p>
            </div>
            <div>
